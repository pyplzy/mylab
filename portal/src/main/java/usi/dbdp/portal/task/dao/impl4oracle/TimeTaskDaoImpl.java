...
@OracleDb
@Repository
public class TimeTaskDaoImpl extends JdbcDaoSupport4oracle implements TimeTaskDao {
	...
	public long addNjob(final SysJobDto job) {//新增
		...
		this.getJdbcTemplate().update(new PreparedStatementCreator(){
			...
			public PreparedStatement createPreparedStatement(Connection con)
					throws SQLException {
				 String sql="INSERT INTO UIC_JOB VALUES(uic_job_seq.nextval,?,?,?,?,?)";
	...
	public List<SysNodeDto> sercAllNode() {//查询所有Node
		String sql="SELECT APP_NODE_ID,NODE_NAME,NODE_TYPE,IP_ADDRESS,PORT_VALUE,CONTENT,CONCAT(CONCAT(IP_ADDRESS,':'),PORT_VALUE)  IPPORT FROM UIC_NODE ";
	...
	public long addNode(final SysNodeDto node) {//新增Node
		...
		this.getJdbcTemplate().update(new PreparedStatementCreator(){
			...
			public PreparedStatement createPreparedStatement(Connection con)
					throws SQLException {
				String sql="INSERT INTO UIC_NODE VALUES(UIC_NODE_SEQ.nextval,?,?,?,?,?)";
	...
	public List<SysTimerDto> search(SysTimerDto timer) {
		...
		String sql="SELECT t1.TIMER_ID,t1.TIMER_NAME,t1.JOB_ID,t1.NODE_ID,t1.CLASS_NAME,t1.EXCUTE_METHOD,t1.TIMER_STATUS,"
				+ " t1.CRON_EXPRESSION,t1.TIMER_DESC,t1.BUSI_PARA,t1.ENABLE,CONCAT(CONCAT(t2.IP_ADDRESS,':'),t2.PORT_VALUE) NODE,t1.ENABLE+t3.ENABLE ISENABLE "
	...
	public int addTask(SysTimerDto t) {
		String sql="INSERT INTO UIC_TIMER VALUES(UIC_TIMER_SEQ.nextval,?,?,?,?,?,?,?,?,?,sysdate,?,0)";
