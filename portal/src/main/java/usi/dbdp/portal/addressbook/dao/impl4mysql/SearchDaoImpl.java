...
@MysqlDb
@Repository
public class SearchDaoImpl extends JdbcDaoSupport4mysql implements SearchDao{
	...
	public List<PtlAddressBook> queryPersonList(PageObj pageObj) {
		String infoSql = "SELECT * FROM PTL_ADDRESS_BOOK";
	...
	public PtlAddressBook queryPersonDetailInfoById(int addressBookId){
		...
		String infoSql = "SELECT * FROM PTL_ADDRESS_BOOK A WHERE A.ADDRESS_BOOK_ID=?";
	...
	public PtlAddressBook queryPersonDetailInfoByUserId(String userId){
		...
		String infoSql = "SELECT * FROM PTL_ADDRESS_BOOK A WHERE A.USER_ID=?";
