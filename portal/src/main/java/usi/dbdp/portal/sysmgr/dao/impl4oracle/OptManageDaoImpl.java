...
@OracleDb
@Repository
public class OptManageDaoImpl extends JdbcDaoSupport4oracle implements OptManageDao{
	...
	public void addResource(ResourceDto resourceDto) {
		String sql = " insert into uic_resource( RESOURCE_ID,APP_CODE,RESOURCE_CODE,RESOURCE_NAME,RESOURCE_DESC) values (uic_resource_seq.nextval,?,?,?,?) ";
		this.getJdbcTemplate().update(sql, new Object[]{
				resourceDto.getAppCode(),
				resourceDto.getResourceCode(),
				resourceDto.getResourceName(),
	...
	public void addOpt(OptDto optDto) {
		String sql = " insert into uic_opt (PRIVILEGE_ID,RESOURCE_ID ,PRIVILEGE_CODE,PRIVILEGE_NAME) values(uic_opt_seq.nextval,?,?,?)";
		this.getJdbcTemplate().update(sql, new Object[]{
