...
public class RoleDaoImpl extends JdbcDaoSupport4mysql implements RoleDao{
	...
	public List<Role> getRolesByAppCodeAndRoleNameWithPage(String appCode,
		...
		String sql = " SELECT t.role_id,t.app_code,t.province,t.role_code,t.role_name,t.role_memo,t.del_flag ,t.role_type ,u.org_name " +
	...
	public List<UserInfo4Session> getUsersByAppCodeAndRoleIdAndUserIdAndUserNameWithPage2(String appCode, User user ,long roleId,
			PageObj pageObj) {
		String sql = "SELECT a.create_time,a.duration,a.gender,a.id,a.lst_err_pwd_time,a.mobile_no,o.org_id,a.password,a.pwd_err_cnt,"
				+ " a.pwd_last_mod_time,a.del_flag,a.user_id,a.user_name,a.user_type,o.org_name,o.org_name_seq   "
				 +" from"
		...
		if (user != null) {
			...
			if (CommonUtil.hasValue(user.getUserName())){
				sql += " and a.user_name like '%" + user.getUserName()+ "%' ";
			}	
		}
	...
	public List<UserInfo> 	getAllOtherUsersWithoutRoleByPage2
		...
		String sql="select u.id ,u.user_id ,u.user_name ,o.org_name_seq   "
