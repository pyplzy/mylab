...
@OracleDb
@Repository
public class DataPriDaoImpl  extends JdbcDaoSupport4oracle implements  DataPriDao{
	/**
	 * @author ma.guangming
	  * 批量保存数据权限
	...
	public List<User> getAdminsByUserIdOrUserNameFromRole(String value,Long province,String userId){
		String sql=" select " +
				" a.create_time,a.duration,a.gender,a.id,a.lst_err_pwd_time,"+OraclePasswdUtil.getDecryptStr("a.mobile_no")+" as mobile_no,b.org_id,a.password,a.pwd_err_cnt,a.pwd_last_mod_time,a.del_flag,a.user_id,"+OraclePasswdUtil.getDecryptStr("a.user_name")+" as user_name,a.user_type " + 
		...
		if(CommonUtil.hasValue(value)){
			sql +=" and ( a.user_id like '%"+value
					+ "%' or "+OraclePasswdUtil.getDecryptStr("a.user_name")+"  like '%"+value
					+ "%'  "
					+ ") ";
		}
