...
@OracleDb
@Repository
public class AuthenticationDaoImpl extends JdbcDaoSupport4oracle implements AuthenticationDao{
	...
	public List<RoleGrantInfo> getRoleGrantInfos(PageObj pageObj,
		...
		String sql =" SELECT a.role_id  , a.APP_CODE , a.ROLE_CODE , a.ROLE_NAME , a.ROLE_MEMO,"+OraclePasswdUtil.getDecryptStr("b.org_name")+" as org_name, " +
