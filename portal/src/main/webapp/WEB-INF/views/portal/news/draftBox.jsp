...
<title>公告管理-草稿箱</title>
	...
	<script type="text/javascript" src="${ctx}/res/javascript/portal/news/draftBox.js" ></script>
</head>
<body>
<div class="wrapOther">
	<div class="btnWrap">
    ...
    <div class="tablebox">
    	<div class="table_head">
        	<div class="choose" style="margin-left:5px"><input type="checkbox" id="choose" style="top:0" /></div>
            <div class="title title22">标题</div>
            <div class="title title33">创建时间</div>
        </div>
    	<table class="items" width="100%" border="0" cellspacing="0" cellpadding="0"></table>
    </div>
   	<!--翻页结束-->
