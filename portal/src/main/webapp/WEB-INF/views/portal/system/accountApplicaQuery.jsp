...
<title>账号申请审核</title>
    ...
    <script type="text/javascript" src="${ctx }/res/javascript/portal/system/accountApplicaQuery.js"></script>
	<style type="text/css">
	...
	<div id="test" class="tabCont" style="z-index:10000;height:800px;">
		<div  class="queryWrapForObj clearfix" >
			...
			<dl style="width:530px">
				<dt>申请单位</dt>
				<dd><input type="text" class="txtInput" style="width:380px"    id="applicationCompany" />
				</dd>
			</dl>
